...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
        <asp:DataList ID="DataList2" runat="server" style="margin-right: 199px" Width="443px">
            <ItemTemplate>
                <table class="auto-style4">
                    <tr>
                      ...
                      <a href="YemekDetay.aspx?Yemekid=<%# Eval("Yemekid") %>">      <asp:Label ID="Label8" runat="server" ForeColor="Black" Text="Yemek: "></asp:Label>
                            <asp:Label ID="Label2" runat="server" ForeColor="White" style="font-weight: 700; font-size: x-large" Text='<%# Eval("YemekAd") %>'></asp:Label></a>
                        </td>
                    </tr>
                    <tr>
