<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminGununYemegi.aspx.cs" Inherits="Yemek_Tarifleri_Site.AdminGununYemegi" %>
                ...
                <table class="auto-style1">
                    <tr>
                        ...
                        <td class="auto-style16">
                            ...
                            <asp:Image ID="Image2" runat="server" Height="41px" ImageUrl="~/resim/select.png" Width="40px" />
                            </a>
                        </td>
                    </tr>
                </table>
